...
def main(args):
    ...
    graph.train_mask = torch.full((2449029,), False, dtype=torch.bool)
    graph.val_mask = torch.full((2449029,), False, dtype=torch.bool)
    graph.test_mask = torch.full((2449029,), False, dtype=torch.bool)
