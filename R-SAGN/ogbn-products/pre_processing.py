...
path = '/home/lixue/Ipy5/OverSmoothing/OGB-Products-Experiments/dgl_ogb_dataset/'
parser = argparse.ArgumentParser()
parser.add_argument("--dataset", type=str, default="ogbn-products")
parser.add_argument('--num_hops', type=int, default=5)
parser.add_argument('--root', type=str, default=path)
parser.add_argument('--giant_path', type=str, default= '/home/lixue/XRT/ogbn-products/X.all.xrt-emb.npy')
